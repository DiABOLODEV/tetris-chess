  ...
  export class Main extends Phaser.State {
    ...
    create() {
      ...
      // le bouton jouer
      var bt = this.game.add.text(this.positions.uiP1.x+this.positions.uiP2.cell.size*12, this.positions.uiP1.y, 'Jouer',  { font : 'Arial', fontSize : 16, boundsAlignH : 'center'});
      ...
      // le bouton jouer
      var bt = this.game.add.text(this.positions.uiP2.x+this.positions.uiP2.cell.size*12, this.positions.uiP2.y, 'Jouer',  { font : 'Arial', fontSize : 16, boundsAlignH : 'center'});
      bt.inputEnabled = true;
